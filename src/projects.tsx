...
const Projects = () => {
    ...
    return(
    <div className="px-24 mt-24 max-lg:px-4">
        ...
        <div className="flex justify-evenly">
            ...
            <a href="https://messaging-jj3zhaxic-brdorads-projects.vercel.app" className="flex justify-center items-center text-white border-2 border-white transition-all ease-out duration-500 btn w-48 h-14 max-lg:w-40 rounded-md font-black font3">
                Live preview
            </a>
            
           
            <a href="https://github.com/brdorad3/MessagingApp" className="flex justify-center items-center text-white border-2 border-white transition-all ease-out duration-500 btn w-48 max-lg:w-40 h-14  rounded-md font2">
                View code
            </a>
        ...
        <div className="flex justify-evenly">
            <a href="https://blog-chi-snowy-38.vercel.app" className="flex justify-center items-center text-white border-2 border-white transition-all ease-out duration-500 btn w-48 h-14 max-lg:w-40 rounded-md font3 ">
                Live preview
            </a>
            <a href="https://github.com/brdorad3/Blog" className="flex justify-center items-center text-white border-2 border-white  w-48 h-14 max-lg:w-40 transition-all ease-out duration-500 btn rounded-md font2">
                View code
            </a>
        </div>
        </div>
        ...
        <div className="flex justify-evenly">
            <a href="https://where-is-waldo-gfa1l20u8-brdorads-projects.vercel.app" className="flex justify-center items-center text-white border-2 border-white transition-all ease-out duration-500 btn w-48 h-14 max-lg:w-40 font3 rounded-md">
                Live preview
            </a>
            <a href="https://github.com/brdorad3/WhereIsWaldo" className="flex justify-center items-center text-white border-2 border-white transition-all ease-out duration-500 btn w-48 h-14 max-lg:w-40 font2 rounded-md">
                View code
            </a>
        </div>
        </div>
